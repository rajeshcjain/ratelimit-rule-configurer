...
public class ThrottlingConfigurationOrmObj {
	...
	public ThrottlingConfigurationOrmObj(final Integer id, final String username, final String http_func, final String uri, final String module, final Integer throttle_limit, final Integer time_limit, final String updated_on, final String status) {
		this.id = id;
	...
	public ThrottlingConfigurationOrmObj() {
	...
	public boolean equals(final Object obj) {
		...
		final ThrottlingConfigurationOrmObj other = (ThrottlingConfigurationOrmObj) obj;
		if (http_func == null) {
	...
	public String toString() {
		return "ThrottlingConfigurationOrmObj [id=" + id + ", username=" + username + ", http_func=" + http_func + ", uri=" + uri + ", module=" + module + ", throttle_limit=" + throttle_limit + ", time_limit=" + time_limit + ", status=" + status + "]";
	}
